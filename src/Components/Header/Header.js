...
class Header extends Component{
    ...
    openProfileDropDown(){
        document.getElementById("profileDropDown").classList.toggle("vp_dropdown_show");
    }
            ...
            <div id="Header" className="header">
                <div className="container">
                    ...
                    <div className="vp_logo">
                        <span className="vp_logo"><img src='/contents/image/XomeLogo.png' alt="Logo" /></span>
                    </div>
                    ...
                    <div className="vp_rightnav">
                        <ul className="vp_nav_ul_right">
                            <li>
                                <div className="vp_dropdown">
                                    <div className="btn vp_header_btn" onClick={this.searchOpen}> 
                                        <span><i className="glyphicon glyphicon-bell" /></span>
                                    </div>
                            ...
                            <li>
                                <Link style={{display : "inline-block"}} to="/UI/Profile"> <span className="vp_n_res_display">Hi { context.User.VendorDetailsModel ? context.User.VendorDetailsModel.VendorName :"Loading..." } </span> <i className="glyphicon glyphicon-user" /></Link>
                            </li>                      
                            <li>
                                <a href="javascript:;"><img src='/contents/image/icon-logout.svg' width="20" height="20" /></a>
                            </li>
                        </ul>
                    </div>
                </div>
